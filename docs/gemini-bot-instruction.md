...
### Референсное фото товара

```text
products/sofa-classic/images/Gemini_Generated_Image_23eg9523eg9523eg.png
```

Это фото дивана — референс для генерации. Все создаваемые изображения должны соответствовать этой модели по форме, пропорциям и дизайну. Меняются только опции (материал, цвет, ножки, размер), но не сама модель.
